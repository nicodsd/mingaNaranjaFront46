...
export default function Carrousel() {
    ...
    return (
        <div className="flex justify-center lg:justify-start">
            <svg onClick={restar} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="bi bi-arrow-bar-left w-0 lg:w-5 transition ease-in-out duration-300">
