      ...
      <div className="bg-white w-full md:w-[30%] py-10 md:py-0 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col items-center mt-6">
          ...
          <form encType="multipart/form-data" className="flex flex-col w-[75%]">
            <label
              htmlFor="name"
              className="flex flex-col px-4 text-[#1F1F1F7c] mt-4 text-xs"
            >
              Name
            </label>
            <input
              ...
              name="name"
              id="name"
              className="border-b border-[#1f1f1f7c] px-4 text-xs py-2"
              ref={name}
            />
            <label
              htmlFor="email"
            ...
            <input
              ...
              name="photo"
              id="photo"
              className="border-b border-[#1f1f1f7c] px-4 text-xs py-2" /* ref={photo} */
            />

            <input
              ref={photo}
              autoComplete="off"
              className="text-[4px] px-[5px] hidden text-black font-montserrat font-[500] outline-none"
              type="file"
              name="photo"
              id="upload"
            />
            <label
              className="bg-black hover:bg-[#222222d8] text-white cursor-pointer duration-100 flex items-center justify-center font-[600] w-[9rem] h-[1.6rem] text-sm rounded-[0_0_4px_4px]"
              htmlFor="upload"
            >
              Upload Image
              <AiOutlineUpload className="text-lg ml-2" />
            </label>
            ...
            <input
              ...
              ref={password}
            />
            <label htmlFor="notification" className="text-xs">
              <input
                type="checkbox"
                name="notification"
                id="notification"
            ...
            <input
              type="submit"
              value="Sign Up"
              className="bg-gradient-to-r from-[#434343]  to-black  text-white rounded-lg py-3 text-sm my-3"
              onClick={handleForm}
            />
          </form>
          ...
          <div className="flex flex-col items-center">
            {props.setShow ? (
              <span className="w-[75%] text-xs mt-4">
              ...
              <Anchor to="/login" className="w-[75%] text-xs mt-4">
                Already have an account?{" "}
                <span className="cursor-pointer text-red-600 font-bold">
                  Sig in
                </span>
              </Anchor>
            )}
